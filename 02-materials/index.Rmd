...
date: "0900&ndash;1500 CET Wednesday 10th June, 2026"
output:
...
```{r cw-fs-model-fit}
m_cw_fs <- gam(
  weight ~ diet + # parametric effect of treatment means
    s(time, by = diet) + # smooths of time effect per treatment level
    s(time, chick, bs = "fs", k = 7), # random smooths per chick
  data = cw, family = tw(), method = "REML",
...
m_cw_fs |> draw(grouped_by = TRUE, rug = FALSE)
```
